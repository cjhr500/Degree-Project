...
Since the model was not fully implemented, the results are somewhat limited. Nevertheless some information may be gleaned from the output produced. Presented below are some of the results of a typical run, with 
\section{Age Structures}
